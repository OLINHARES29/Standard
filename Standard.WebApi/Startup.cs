...
using Standard.DependencyInjection;
using Standard.Framework.Filter.Concretes;
using Standard.WebApi.Configurations;
...
namespace Standard.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                s.SwaggerDoc("v1", new Info { Title = "Microservice API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Arquivo application");
            });
